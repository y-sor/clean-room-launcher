...
while IFS= read -r file; do
  relative=${file#"$root"/}
  case "$relative" in
    AGENTS.md|README.md|CONTRIBUTING.md|Cargo.toml|Cargo.lock|rust-toolchain.toml|LICENSE|SECURITY.md|GOVERNANCE.md|CHANGELOG.md|deny.toml|install.sh|.gitignore|.github/CODEOWNERS|.github/FUNDING.yml|.github/dependabot.yml|.github/scorecard.yml|.github/workflows/ci.yml|.github/workflows/release.yml|.github/workflows/release-candidate.yml|.github/workflows/release-promotion-rehearsal.yml|.github/workflows/indexnow.yml|.github/workflows/scorecard.yml|.github/workflows/codeql.yml|.github/workflows/dependency-review.yml|.github/workflows/fuzz.yml|schemas/canonical-json-profile.md) ;;

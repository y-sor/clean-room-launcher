...
## v0.4.3: select one installed whole plugin

The v0.4.3 source adds one bounded Codex whole-plugin selector for the
...
The exact v0.4.3 qualification target is Codex CLI `0.156.1` on macOS Apple

...
| Version | Status |
| --- | --- |
| `0.4.4` | Current qualified source contract; see GitHub Releases for publication status |
...
The v0.4.4 qualification is limited to macOS on Apple Silicon. Minimum accepted
